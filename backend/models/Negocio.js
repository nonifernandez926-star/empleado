...
const negocioSchema = new mongoose.Schema({
  ...
  // a cada puesto. El asistente le avisa al cliente cuando vuelve y esta en el TOP 3, y si el premio
  // tiene un % de descuento, se lo aplica de verdad al total de su compra (no solo lo menciona).
  ranking: {
