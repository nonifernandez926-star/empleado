...
const CAMPOS_COMUNES = [
  ...
  { id: 'informacionAdicional', label: 'Algo mas que quieras que tu asistente sepa y no se pregunto arriba', tipo: 'textoLargo', obligatorio: false },
];
  ...
  },
  {
    ...
    subrubros: [
      { id: 'clinica', tipoOperacion: 'turnos', nombre: 'Clinica', camposEspecificos: [
        { id: 'especialidadesYProfesionales', label: 'Especialidades que atiende y nombre de cada profesional (ej: Dr. Perez - Cardiologia, Dra. Gomez - Pediatria)', tipo: 'textoLargo', obligatorio: true },
        { id: 'duracionPorMotivo', label: 'Duracion aproximada segun el tipo de consulta (ej: consulta general 20 min, control 15 min, primera vez 40 min)', tipo: 'textoLargo', obligatorio: true },
        ...
        { id: 'formaDeAtencion', label: 'Como se atiende', tipo: 'seleccionUnica', obligatorio: true, opciones: ['Solo con turno', 'Turno y tambien por orden de llegada', 'Ambos segun la especialidad'] },
        { id: 'documentacionRequerida', label: 'Que debe llevar el paciente (DNI, carnet de la obra social, estudios previos, etc.)', tipo: 'textoLargo', obligatorio: false },
        { id: 'politicaCancelacion', label: 'Con cuanta anticipacion se puede cancelar o reprogramar un turno sin penalidad?', tipo: 'texto', obligatorio: false },
        { id: 'sedes', label: 'Direcciones de cada sede, si tienen mas de una', tipo: 'textoLargo', obligatorio: false },
        { id: 'edadesAtendidas', label: 'Atienden todas las edades o hay restriccion (ej: solo adultos, pediatria hasta 12 anios)?', tipo: 'texto', obligatorio: false },
        { id: 'guardia24h', label: 'Tiene guardia 24hs?', tipo: 'booleano', obligatorio: false },
        { id: 'protocoloEmergencia', label: 'Que debe hacer un paciente si es una emergencia (a que guardia u hospital derivar). El asistente nunca debe intentar diagnosticar.', tipo: 'textoLargo', obligatorio: true },
      ]},
      { id: 'consultorio_medico', tipoOperacion: 'turnos', nombre: 'Consultorio medico', camposEspecificos: [
        ...
        { id: 'nombreProfesional', label: 'Nombre del profesional (o de cada uno, si son varios)', tipo: 'textoLargo', obligatorio: true },
        { id: 'motivosYDuracion', label: 'Motivos de consulta mas comunes y su duracion (ej: primera vez 40 min, control 20 min)', tipo: 'textoLargo', obligatorio: true },
        { id: 'obrasSociales', label: 'Obras sociales / prepagas aceptadas', tipo: 'textoLargo', obligatorio: true },
        { id: 'requiereOrden', label: 'Requiere orden medica para atender?', tipo: 'booleano', obligatorio: false },
        { id: 'documentacionRequerida', label: 'Que debe llevar el paciente a la consulta', tipo: 'textoLargo', obligatorio: false },
        { id: 'politicaCancelacion', label: 'Con cuanta anticipacion se puede cancelar o reprogramar sin penalidad?', tipo: 'texto', obligatorio: false },
        { id: 'atiendeAObraSocialYParticular', label: 'Atiende por obra social y tambien de forma particular?', tipo: 'booleano', obligatorio: false },
        { id: 'protocoloEmergencia', label: 'Que debe hacer el paciente ante una emergencia (a donde derivar). El asistente nunca debe intentar diagnosticar.', tipo: 'textoLargo', obligatorio: true },
      ]},
      { id: 'odontologia', tipoOperacion: 'turnos', nombre: 'Odontologia', camposEspecificos: [
        { id: 'tratamientos', label: 'Tratamientos que ofrece (limpieza, ortodoncia, endodoncia, implantes, blanqueamiento, etc.)', tipo: 'textoLargo', obligatorio: true },
        { id: 'duracionPorTratamiento', label: 'Duracion aproximada de cada tipo de turno (ej: control 20 min, extraccion 40 min, primera consulta 30 min)', tipo: 'textoLargo', obligatorio: true },
        { id: 'obrasSociales', label: 'Obras sociales / prepagas aceptadas', tipo: 'textoLargo', obligatorio: true },
        { id: 'urgencias', label: 'Atiende urgencias dentales fuera de turno?', tipo: 'booleano', obligatorio: false },
        { id: 'financiacion', label: 'Ofrecen financiacion o planes de pago para tratamientos largos?', tipo: 'textoLargo', obligatorio: false },
        { id: 'atiendeNinos', label: 'Atienden odontopediatria (ninios)?', tipo: 'booleano', obligatorio: false },
        { id: 'politicaCancelacion', label: 'Con cuanta anticipacion se puede cancelar o reprogramar sin penalidad?', tipo: 'texto', obligatorio: false },
      ]},
      { id: 'farmacia', tipoOperacion: 'pedidos', nombre: 'Farmacia', camposEspecificos: [
        { id: 'servicios', label: 'Servicios (vacunatorio, toma de presion, obras sociales, perfumeria, etc.)', tipo: 'textoLargo', obligatorio: true },
        { id: 'delivery', label: 'Hace envios a domicilio? Zona de cobertura y tiempo estimado', tipo: 'textoLargo', obligatorio: false },
        { id: 'guardia24h', label: 'Es farmacia de turno / abre 24hs? En que dias', tipo: 'textoLargo', obligatorio: false },
        { id: 'requiereReceta', label: 'Que tipo de medicamentos requieren receta obligatoria?', tipo: 'textoLargo', obligatorio: false },
        { id: 'consultaStock', label: 'El asistente puede confirmar si hay stock de un medicamento puntual, o solo dar informacion general?', tipo: 'booleano', obligatorio: false },
        { id: 'aceptaObrasSociales', label: 'Trabaja con obras sociales / descuentos por receta?', tipo: 'textoLargo', obligatorio: false },
      ]},
      { id: 'laboratorio', tipoOperacion: 'turnos', nombre: 'Laboratorio', camposEspecificos: [
        ...
        { id: 'requiereAyuno', label: 'Que estudios requieren ayuno y de cuantas horas?', tipo: 'textoLargo', obligatorio: false },
        { id: 'requiereOrden', label: 'Requiere orden medica para todos los estudios, o hay excepciones?', tipo: 'textoLargo', obligatorio: false },
        { id: 'horarioExtraccion', label: 'Horario de toma de muestras (puede ser distinto al horario general de atencion)', tipo: 'texto', obligatorio: false },
        { id: 'entregaResultados', label: 'En cuanto tiempo se entregan los resultados y por que medio (papel, online, mail)?', tipo: 'textoLargo', obligatorio: false },
        { id: 'requiereTurnoPrevio', label: 'Se necesita turno previo para hacerse los estudios, o se atiende por orden de llegada?', tipo: 'booleano', obligatorio: false },
      ]},
      { id: 'kinesiologia', tipoOperacion: 'turnos', nombre: 'Kinesiologia', camposEspecificos: [
        { id: 'tratamientos', label: 'Tratamientos y especialidades (rehabilitacion, deportiva, respiratoria, neurologica, etc.)', tipo: 'textoLargo', obligatorio: true },
        { id: 'duracionSesion', label: 'Duracion de una sesion tipica', tipo: 'texto', obligatorio: false },
        { id: 'obrasSociales', label: 'Obras sociales aceptadas', tipo: 'textoLargo', obligatorio: false },
        { id: 'requiereOrden', label: 'Requiere orden medica derivando al tratamiento?', tipo: 'booleano', obligatorio: false },
        { id: 'atencionDomicilio', label: 'Hacen sesiones a domicilio? En que zona', tipo: 'textoLargo', obligatorio: false },
        { id: 'cantidadSesionesPromedio', label: 'Cuantas sesiones suele necesitar un tratamiento tipico?', tipo: 'texto', obligatorio: false },
      ]},
      { id: 'psicologia', tipoOperacion: 'turnos', nombre: 'Psicologia', camposEspecificos: [
        { id: 'enfoque', label: 'Enfoque / especialidad (individual, pareja, ninios, adolescentes, familiar, etc.)', tipo: 'textoLargo', obligatorio: true },
        ...
        { id: 'frecuenciaRecomendada', label: 'Frecuencia habitual de sesiones (semanal, quincenal, etc.)', tipo: 'texto', obligatorio: false },
        { id: 'obrasSociales', label: 'Trabaja con obras sociales / prepagas?', tipo: 'textoLargo', obligatorio: false },
        { id: 'politicaCancelacion', label: 'Con cuanta anticipacion se puede cancelar sin penalidad?', tipo: 'texto', obligatorio: false },
        { id: 'confidencialidad', label: 'Texto sobre confidencialidad que el asistente puede citar si el paciente pregunta', tipo: 'textoLargo', obligatorio: false },
      ]},
      { id: 'nutricion', tipoOperacion: 'turnos', nombre: 'Nutricion', camposEspecificos: [
        { id: 'especialidadNutricion', label: 'Especialidad (deportiva, clinica, pediatrica, trastornos alimentarios, etc.)', tipo: 'texto', obligatorio: false },
        { id: 'modalidad', label: 'Modalidad', tipo: 'seleccionUnica', obligatorio: false, opciones: ['Presencial', 'Virtual', 'Ambas'] },
        { id: 'duracionPrimeraConsulta', label: 'Duracion de la primera consulta y de los controles siguientes', tipo: 'textoLargo', obligatorio: false },
        { id: 'incluyePlan', label: 'La consulta incluye plan alimentario por escrito?', tipo: 'booleano', obligatorio: false },
        { id: 'requiereEstudiosPrevios', label: 'Piden analisis o estudios antes de la primera consulta?', tipo: 'booleano', obligatorio: false },
        { id: 'obrasSociales', label: 'Trabaja con obras sociales / prepagas?', tipo: 'textoLargo', obligatorio: false },
      ]},
      { id: 'veterinaria', tipoOperacion: 'turnos', nombre: 'Veterinaria', camposEspecificos: [
        { id: 'servicios', label: 'Servicios (consultas, vacunacion, cirugias, internacion, peluqueria canina, etc.)', tipo: 'textoLargo', obligatorio: true },
        { id: 'animalesAtendidos', label: 'Tipos de animales que atienden', tipo: 'textoLargo', obligatorio: true },
        { id: 'duracionPorMotivo', label: 'Duracion aproximada segun el motivo (consulta general, cirugia, vacunacion, etc.)', tipo: 'textoLargo', obligatorio: false },
        ...
        { id: 'internacion', label: 'Cuentan con internacion propia o derivan a otro lugar?', tipo: 'textoLargo', obligatorio: false },
        { id: 'documentacionRequerida', label: 'Que debe llevar el dueno de la mascota (libreta sanitaria, carnet de vacunas, etc.)', tipo: 'textoLargo', obligatorio: false },
      ]},
      { id: 'salud_otros', tipoOperacion: 'turnos', nombre: 'Otros', camposEspecificos: [
        ...CAMPOS_OTROS,
        { id: 'requiereOrden', label: 'Requiere alguna orden, derivacion o requisito previo para atender?', tipo: 'booleano', obligatorio: false },
        { id: 'duracionPorMotivo', label: 'Duracion aproximada segun el tipo de consulta o servicio', tipo: 'textoLargo', obligatorio: false },
        { id: 'obrasSociales', label: 'Trabaja con obras sociales / prepagas?', tipo: 'textoLargo', obligatorio: false },
      ] },
    ],
  },
